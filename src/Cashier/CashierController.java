...
public class CashierController implements Initializable {
    ...
    private void ViewOrderAction(ActionEvent event) throws IOException {
        ...
        content.getChildren().setAll((AnchorPane) FXMLLoader.load(getClass().getResource("ManageOrder.fxml")));
    }
    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        // Button was clicked, do something...
        System.out.println("abc");
        content.getChildren().setAll((AnchorPane) FXMLLoader.load(getClass().getResource("HandlePayment.fxml")));
